...
export const DEFAULT_CATEGORIES: Category[] = [
  { id: 'all', name: 'All Products', icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><defs><linearGradient id="ag" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3B82F6"/><stop offset="100%" stop-color="#0058C7"/></linearGradient></defs><path d="M2 3h1.5l.5 1h16l-2 8H6L4.5 4H3L2 3z" fill="url(#ag)"/><circle cx="7" cy="17" r="2" fill="#0058C7"/><circle cx="15" cy="17" r="2" fill="#3B82F6"/></svg>' },
