// [REPLACE] ফাইলের পাথ: app/checkout/status/StatusClient.tsx
'use client';
...
export default function StatusClient() {
  ...
  return (
    <>
      <div className="relative min-h-dvh overflow-hidden bg-gradient-to-b from-brand-bg/45 via-[#DCEBFD]/55 to-white px-4 py-8 sm:py-12 flex items-center justify-center">
        {/* মেইন কন্টেইনার — সিগনেচার ট্রাই-কালার ক্যানভাস */}
        <div className="relative z-10 w-full max-w-[440px] overflow-hidden rounded-[28px] bg-gradient-to-b from-brand-bg via-[#DCEBFD] to-white p-6 sm:p-7 text-center shadow-sh3 ring-1 ring-white/80 animate-section-reveal">
          <HeaderDecor />
          ...
          {isPending && (
            <>
              ...
              {/* সাইটে ফিরে যাওয়ার প্রাইমারি বাটন */}
              <Link
                href="/"
