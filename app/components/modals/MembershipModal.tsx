                ...
                {!activeReward ? (
                  <div className="flex flex-col items-center">
                    ...
                    <button
                      ...
                      className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-info to-brand-light py-2.5 font-body text-xs sm:text-sm font-bold text-white shadow-sh2 transition-all duration-brand hover:brightness-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSpinning
                        ? t('চাকা ঘুরছে...')
                        : !isSelectedTierUnlocked
                ...
                {!activeReward ? (
                  <div className="flex flex-col items-center">
                    ...
                    <button
                      ...
                      disabled={isSpinning || !isSelectedTierUnlocked}
                      className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-gradient-to-r from-amber-500 to-amber-600 py-2.5 font-body text-xs sm:text-sm font-bold text-white shadow-sh2 transition-all duration-brand hover:brightness-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {isSpinning
                        ? t('চাকা ঘুরছে...')
                        : !isSelectedTierUnlocked
