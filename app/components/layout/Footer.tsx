  ...
  return (
    <footer className="mt-[52px] bg-ink text-white">
      <div className="mx-auto grid max-w-[1300px] grid-cols-1 gap-10 px-5 py-[42px] md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] 2xl:max-w-[1560px]">
          ...
          <div>
            {logo.mode === 'image' ? (
              ...
              <>
                ...
                <div className="mt-0.5 text-[9px] uppercase tracking-[2px] text-brand-primary">{logo.sub}</div>
              </>
            )}
          </div>
        ...
        <div>
          <h4 className="mb-[13px] text-[11.5px] font-bold uppercase tracking-[.6px] text-white/60">Customer Service</h4>
        ...
        <div>
          <h4 className="mb-[13px] text-[11.5px] font-bold uppercase tracking-[.6px] text-white/60">CONTACT</h4>
      ...
      <div className="border-t border-white/[.08] px-5 py-[18px] text-center">
        <div className="text-[13px] font-medium text-brand-primary">{extras.copy}</div>
      </div>
    </footer>
  );
}
