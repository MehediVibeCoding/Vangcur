      ...
      <div className="mx-auto grid max-w-[1300px] grid-cols-1 gap-10 px-5 py-[42px] md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] 2xl:max-w-[1560px]">
        <div>
          ...
          <div className="mt-4 flex gap-[9px]">
            ...
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-light [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.ig} target="_blank" rel="noopener noreferrer" title="Instagram">
            ...
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-light [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.tk} target="_blank" rel="noopener noreferrer" title="TikTok">
              <svg viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.76a4.85 4.85 0 01-1.01-.07z" /></svg>
            </a>
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-light [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.wa} target="_blank" rel="noopener noreferrer" title="WhatsApp">
            ...
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-light [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.yt} target="_blank" rel="noopener noreferrer" title="YouTube">
