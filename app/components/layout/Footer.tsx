...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-[52px] bg-gradient-to-b from-ink to-[#0f1a2e] text-white">
      <div className="h-[3px] w-full bg-gradient-to-r from-brand-bg via-brand-light-hover to-brand-light" />
      <div className="mx-auto grid max-w-[1300px] grid-cols-1 gap-10 px-5 py-[42px] md:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] 2xl:max-w-[1560px]">
        <div>
          ...
          <div className="mt-4 flex gap-[9px]">
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-primary [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.fb} target="_blank" rel="noopener noreferrer" title="Facebook">
              <svg viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
            </a>
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-primary [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.ig} target="_blank" rel="noopener noreferrer" title="Instagram">
            ...
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-primary [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.tk} target="_blank" rel="noopener noreferrer" title="TikTok">
              <svg viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1V9.01a6.33 6.33 0 00-.79-.05 6.34 6.34 0 00-6.34 6.34 6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.33-6.34V8.69a8.18 8.18 0 004.78 1.52V6.76a4.85 4.85 0 01-1.01-.07z" /></svg>
            </a>
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-primary [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.wa} target="_blank" rel="noopener noreferrer" title="WhatsApp">
            ...
            <a className="flex h-[35px] w-[35px] items-center justify-center rounded-[9px] border-0 bg-white/[.08] text-white no-underline transition-brand duration-brand hover:bg-brand-primary [&_svg]:h-[17px] [&_svg]:w-[17px] [&_svg]:fill-white" href={extras.social.yt} target="_blank" rel="noopener noreferrer" title="YouTube">
        ...
        <div>
          <h3 className="mb-[13px] text-[11.5px] font-bold uppercase tracking-[.6px] text-white/60">{t('কুইক লিঙ্কস')}</h3>
        ...
        <div>
          <h3 className="mb-[13px] text-[11.5px] font-bold uppercase tracking-[.6px] text-white/60">Customer Service</h3>
          {(serviceLinks || DEFAULT_SERVICE_LINKS).map((lnk, i) => (
            <div key={i} className="mb-[9px]">{renderServiceLink(lnk, i)}</div>
          ))}
        </div>

        <div>
          <h3 className="mb-[13px] text-[11.5px] font-bold uppercase tracking-[.6px] text-white/60">CONTACT</h3>
          <a className={colLinkClass + ' mb-[9px]'} href={contact.phoneHref}>📞 {contact.phoneLabel}</a>
          <a className={colLinkClass + ' mb-[9px]'} href={`mailto:${contact.email}`}>✉️ {contact.email}</a>
          <a className={colLinkClass + ' mb-[9px]'} href={contact.waHref} target="_blank" rel="noopener noreferrer">💬 WhatsApp Support</a>
          <a className={colLinkClass + ' mb-[9px]'} href={contact.fb} target="_blank" rel="noopener noreferrer">📘 Facebook Page</a>
          <p className="mt-2 text-xs text-white/75">📍 {contact.addr}</p>
        </div>
      </div>
