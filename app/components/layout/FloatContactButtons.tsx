  ...
  return (
    <>
      <a
        ...
        className="fixed bottom-[86px] left-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#0084FF] shadow-sh3 transition-brand duration-brand hover:scale-105"
      >
      ...
      <a
        ...
        className="fixed bottom-5 left-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-sh3 transition-brand duration-brand hover:scale-105"
      >
        <svg width="24" height="24" fill="white" viewBox="0 0 24 24">
