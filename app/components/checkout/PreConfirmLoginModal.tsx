...
const secondaryBtnClass =
  'mb-2.5 w-full rounded-full border-[1.5px] border-[#E8EAED] bg-white py-[13px] font-body text-sm font-bold text-ink transition-colors hover:bg-surface-muted';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative z-10 w-full max-w-[400px] overflow-hidden rounded-[24px] bg-white shadow-sh3 ring-1 ring-black/5"
          >
            ...
            <div className="px-6 pb-6 pt-5">
              ...
              <motion.button
                ...
                onClick={onRegister}
                className="mb-2.5 w-full rounded-full bg-ink py-[13px] font-body text-sm font-bold text-white shadow-[0_4px_16px_rgba(0,0,0,.2)] transition-colors hover:bg-brand-primary"
              >
                {t('রেজিস্ট্রেশন করুন')}
              </motion.button>
              ...
              <motion.button
                ...
                transition={{ type: 'spring', stiffness: 500, damping: 25 }}
                onClick={onGoogle}
                className="mb-4 flex w-full items-center justify-center gap-2.5 rounded-full border-[1.5px] border-[#E8EAED] bg-white py-3 font-body text-sm font-semibold text-ink transition-colors hover:bg-surface-muted"
              >
              ...
              <motion.button
                whileTap={{ scale: 0.98 }}
                onClick={onSkip}
                className="w-full bg-transparent p-1.5 text-center font-body text-[13px] font-semibold text-[#aaa] transition-colors hover:text-ink"
              >
