    ...
    extend: {
      ...
      keyframes: {
        ...
        truckDrive: {
          ...
          '14%': { right: '24px', opacity: '1' },
          '40%': { right: '24px', opacity: '1' },
          '54%': { right: '10px', opacity: '1' },
          '64%': { right: '100px', opacity: '1' },
          '84%': { right: '100px', opacity: '1' },
          '96%': { right: '-100px', opacity: '1' },
          '100%': { right: '-100px', opacity: '0' },
        },
        packageDrop: {
          '0%, 16%': { opacity: '0', transform: 'translateY(-14px) scale(.5)' },
          '24%': { opacity: '1', transform: 'translateY(0) scale(1)' },
          '30%': { opacity: '1', transform: 'translateY(0) scale(1)' },
          '40%': { opacity: '0', transform: 'translateY(0) translateX(85px) scale(.3)' },
          '100%': { opacity: '0' },
        },
        doorFlapTop: {
          '0%, 26%': { transform: 'rotate(-52deg)', opacity: '0' },
          '30%': { transform: 'rotate(-52deg)', opacity: '1' },
          '42%': { transform: 'rotate(0deg)', opacity: '1' },
          '50%, 100%': { transform: 'rotate(0deg)', opacity: '0' },
        },
        doorFlapBottom: {
          '0%, 26%': { transform: 'rotate(52deg)', opacity: '0' },
          '30%': { transform: 'rotate(52deg)', opacity: '1' },
        ...
        roadDash: {
          '0%, 50%': { opacity: '0', backgroundPositionX: '0px' },
          '58%': { opacity: '1', backgroundPositionX: '0px' },
          '84%': { opacity: '1', backgroundPositionX: '-160px' },
          '96%, 100%': { opacity: '0' },
        },
      },
      animation: {
        ...
        'truck-drive': 'truckDrive 3.4s cubic-bezier(.4,0,.2,1) forwards',
        'package-drop': 'packageDrop 3.4s cubic-bezier(.4,0,.2,1) forwards',
        'door-flap-top': 'doorFlapTop 3.4s cubic-bezier(.4,0,.2,1) forwards',
        'door-flap-bottom': 'doorFlapBottom 3.4s cubic-bezier(.4,0,.2,1) forwards',
        'truck-headlight': 'truckHeadlight 3.4s cubic-bezier(.4,0,.2,1) forwards',
        'road-dash': 'roadDash 3.4s cubic-bezier(.4,0,.2,1) forwards',
      },
    },
  },
  plugins: [
